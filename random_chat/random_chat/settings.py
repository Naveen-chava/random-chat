...
SECRET_KEY = 'django-insecure-3qa4p*zzdwqdr160&=_ce5rn8k_4=2q6qyyj*sb97uo%)y1p%2'
...
REST_FRAMEWORK = {
   'DEFAULT_AUTHENTICATION_CLASSES': (
    ...
    #    'rest_framework.authentication.SessionAuthentication',
       'auth.auth_class.CustomTokenAuthentication',
   ),
...
#     "channels_auth.auth.AuthMiddlewareStack",
# ]
####################################################################
